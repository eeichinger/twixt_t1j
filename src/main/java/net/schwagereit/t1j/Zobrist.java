...
public class Zobrist
{
   ...
   {
      private long valueX; //value if pin set by XPlayer
      private long valueY; //value if pin set by YPlayer

      private final long[] bridge = new long[4];
   }

   final private static class UniqueRng {
      /* taken from Polyglot http://hgm.nubati.net/xboard/book.c */
      private static final long[] random64 = {0x9D39247E33776D41L, 0x2AF7398005AAA5C7L, 0x44DB015024623547L, 0x9C15F73E62A76AE2L, 0x75834465489C0C89L,
      ...
      private final Set<Long> alreadyDrawn;
      ...
      public UniqueRng(long seed) {
         rand = new Random();
         ix = 0;
         alreadyDrawn = new HashSet<Long>(Board.MAXDIM*Board.MAXDIM);
      }
    ...
    * @return int
    */
   public long getPinValue(int x, int y, int player)
   {
    ...
    * @return int
    */
   public long getLinkValue(int x, int y, int link)
   {
